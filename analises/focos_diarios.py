...
analysis_date = exec_date.replace(
    day=(exec_date.day - 1), hour=0, minute=0, second=0, microsecond=0
)
...
nfocos = occurrence.count(
    dynamic_data, exec_date_seconds_fmt, id_name, id_dyn_join, filter_by
)
